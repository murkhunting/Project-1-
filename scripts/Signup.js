...
class Signup {
  constructor() {
    ...
    this.planetInput = document.querySelector("#planet");
  ...
  saveData = (event) => {
    ...
    const planet = this.planetInput.value;
    const email = this.emailInput.value;
    const password = this.passwordInput.value;

    // create the new user
    const newUser = new User(name, planet, email, password);
